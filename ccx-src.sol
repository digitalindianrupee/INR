...
contract CCXTokenERC20 {
    string public constant _myTokeName = 'Indian Rupee';//change here
    string public constant _mySymbol = 'INR';//change here
    uint public constant _myinitialSupply = 100000000000000;//leave it
